<%-- 
    Document   : signup.jsp
    Created on : May 22, 2017, 12:18:47 PM
...
<html>
    <head>
        ...
        <title>Remember Me - Signup</title>
                            ...
                            <div class="col-md-12" style="padding: 60px; background-color: white; margin-top:30px; box-shadow: 5px 5px 3px #888888;">
                                ...
                                <div class="row" id="signupContent">
                                    <div class="form-group" style="margin-top: 30px">
                                        <input type="text" class="form-control" id="name" placeholder="Enter your name" onchange="checkName()" style="color: #489FDF;"/>
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control" id="repassword" placeholder="Re-enter password." onchange="recheckPassword()" style="color: #489FDF;"/>
                                        <small id="repasswordHelp" class="form-text text-muted"></small>
                                    </div>
                                    <button class="btn btn-block" onclick="next1();" style="background-color:#489FDF; color: white;">
                                        Next
                                    </button>
                                    <p class="form-text text-muted" style="margin-top: 10px">Already have an account? <a href="login.jsp">Login</a></p>
